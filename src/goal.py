...
KeyWord = {"กลับบ้าน":"Standby_Station",
            "ไปห้องหนึ่ง":"go_room_one",
            "ไปห้องสอง":"go_room_two",
            "ไปห้องสาม ":"go_room_three",
            "ไปห้องสี่":"go_room_four",         
            }



Goal = {"go_room_one":[-4.2,-2.2,0,0.7511],
        "go_room_two":[-4.1,-6.5,0,0.7511],
        "go_room_three":[-9.8,-2.2,-0,0.7511],
        "go_room_four":[-10.17,-6.85,-0,0.7511],
        
        "Standby_Station":[2.75,-0.60,0,0.7511]}
